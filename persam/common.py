...
def get_sim_map(predictor:SamPredictor, features: torch.Tensor, target_feat:torch.Tensor,sim_probe:Optional[nn.Module]) -> torch.Tensor:
    test_feat = features.squeeze()
